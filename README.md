...
Install the Playwright browser (required for JS-rendered quizzes):

playwright install chromium

If you run this inside WSL:

sudo apt-get update
sudo apt-get install -y libnspr4 libnss3 libasound2t64 libatk1.0-0 libcups2 libxdamage1 libpango-1.0-0 libcairo2 libgdk-pixbuf2.0-0
playwright install chromium
